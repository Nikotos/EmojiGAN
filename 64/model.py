...
class Generator(nn.Module):
    def __init__(self, d = 128):
        ...
        self.features.add_module('deconv1', HorseUnit(100, d * 8, 4, 1, 0))     # 1x1 -> 4x4
        self.features.add_module('deconv2', HorseUnit(d * 8, d * 4, 4, 2, 1))     # 4x4 -> 8x8
        self.features.add_module('deconv3', HorseUnit(d * 4, d * 2, 4, 2, 1))      # 8x8 -> 16x16
        self.features.add_module('deconv4', HorseUnit(d * 2, d, 4, 2, 1))      # 16x16 -> 32x32
        self.features.add_module('deconv5', nn.ConvTranspose2d(d, 3, 4, stride = 2, padding = 1))       #32x32 -> 64x64
...
class Discriminator(nn.Module):
    def __init__(self, d = 128):
        ...
        self.features.add_module('conv3', DonkeyUnit(d * 2, d * 4, 4, 2, 1))    # 16x16 -> 8x8
        self.features.add_module('conv4', DonkeyUnit(d * 4, d * 8, 4, 2, 1))    # 8x8 -> 4x4
        self.features.add_module('conv5', nn.Conv2d(d * 8, 1, 4, stride = 1, bias = False))      # 4x4 -> 1x1
